...
function LoadLoginBox()
{
  if(loginStatus == "false") {
	document.getElementById('PlayNowContainer').childNodes[0].childNodes[1].childNodes[1].src = IMAGES + "/buttons/mediumbutton_playnow.png";
    document.getElementById('LoginstatusText_1_1').style.backgroundImage = "url('"  + IMAGES + "/loginbox/loginbox-font-create-account.gif')";
    document.getElementById('LoginstatusText_2').style.backgroundImage = "url('"  + IMAGES + "/loginbox/loginbox-font-create-account-over.gif')";
  } else {
    document.getElementById('PlayNowContainer').childNodes[0].childNodes[1].childNodes[1].src = IMAGES + "/buttons/mediumbutton_myaccount.png";
    document.getElementById('LoginstatusText_1_1').style.backgroundImage = "url('"  + IMAGES + "/loginbox/loginbox-font-logout.gif')";
    document.getElementById('LoginstatusText_2').style.backgroundImage = "url('"  + IMAGES + "/loginbox/loginbox-font-logout-over.gif')";
  }
}
