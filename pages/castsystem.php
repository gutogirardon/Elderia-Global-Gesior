...
foreach($players_online_data as $player)
{
	...
	if ($player['password'] == 1) {
		$imagem = $layout_name . '/images/pages/cast/change_password.png';
	} else {
		$imagem = $layout_name . '/images/pages/cast/door_out.png';
	}
    $players_rows .= '
    <TR BGCOLOR='.$bgcolor.'>
	...
	<div class="TableContainer" >
        ...
        <TR >
            <TD>';
            $main_content .= 'Atualmente temos '.$number_of_players_online.' casts ativos';
            $main_content .= ' no '.$world_name.'<br>
            </TD>
        </TR>
    </TABLE>
	<br>
