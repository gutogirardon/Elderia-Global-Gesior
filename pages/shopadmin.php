...
if($group_id_of_acc_logged >= $config['site']['access_admin_panel']) {
	...
	if($action == "addoffer"){
		...
		if(empty($shop_points)) {
			$main_content .= '<table border="0"><tr><td  align="center"><b>Select offer type:</b></td><td><table border="0" ><tr bgcolor="#505050">
				<td><font color="white">Item</td><td><font color="white">Item VIP</td><td><font color="white">Container</td><td><font color="white">Addons</td><td><font color="white">Mounts</td><td><font color="white">Redskull</td>
				...
				<td align="center"><input type="radio" name="offer_type" value="addon" onClick="this.form.submit()"></td>
				<td align="center"><input type="radio" name="offer_type" value="mount" onClick="this.form.submit()"></td>
			...
			$main_content .= '<form action="?subtopic=shopadmin&action=addoffer&offer_type='.$shop_offer_type.'&offer_category='.$shop_offer_category.'" method="post" ><table border="0"><tr>
			...
			if($_REQUEST['offer_type'] == 'container'){
				$main_content .= '<tr><td align="center" ><b>Container ID:</b></td>
					...
					<tr><td align="center"><b>Number Category:</b></td>
					<td><input type="text" name="shop_offer_category" maxlenght="7" style="width: 70px" ></td></tr>';
			}
			...
			if($_REQUEST['offer_type'] == 'addon'){
				$main_content .= '<tr><td align="center"><b>Outfit ID Male:</b></td>
					<td><input type="text" name="shop_itemid1" maxlenght="7" style="width: 70px" ></td></tr>
					<tr><td align="center"><b>Outfit ID Male:</b></td>
					<td><input type="text" name="shop_count1" maxlenght="7" style="width: 70px" ></td></tr>
										<tr><td align="center"><b>Number Category:</b></td>
					<td><input type="text" name="shop_offer_category" maxlenght="7" style="width: 70px" ></td></tr>';

			}
			if($_REQUEST['offer_type'] == 'mount'){
				$main_content .= '<tr><td align="center"><b>Mount ID:</b></td>
					<td><input type="text" name="shop_itemid1" maxlenght="7" style="width: 70px" ></td></tr>
					<tr><td align="center"><b>Item Count (0):</b></td>
					<td><input type="text" name="shop_count1" maxlenght="7" style="width: 70px" ></td></tr>
										<tr><td align="center"><b>Number Category:</b></td>
					<td><input type="text" name="shop_offer_category" maxlenght="7" style="width: 70px" ></td></tr>';
			...
			$shop_offer_category = stripslashes(trim($_POST['shop_offer_category']));

			$SQL->query('INSERT INTO `z_shop_offer` (id, points, itemid1, count1, itemid2, count2, offer_type, offer_description, offer_name, offer_category, offer_new, pid) VALUES (NULL, '.$SQL->quote($shop_points).', '.$SQL->quote($shop_itemid1).', '.$SQL->quote($shop_count1).', '.$SQL->quote($shop_itemid2).', '.$SQL->quote($shop_count2).', 
				'.$SQL->quote($shop_offer_type).', 
				'.$SQL->quote($shop_offer_description).', 
				'.$SQL->quote($shop_offer_name).', 
				'.$SQL->quote($shop_offer_category).', 
				0, 
				0)');
			$main_content .= '<center><h2><font color="red">
			Adicionado ao shop:</font></h2></center><hr/>
			...
			if($shop_offer_type == 'container'){
				$main_content .= '<tr><td align="center" ><b>Container ID:</b></td>
					...
					<td>'.$shop_offer_category.'</td></tr><br>';
			...
			if ($shop_offer_type == 'itemvip'){
				$main_content .= '<tr><td align="center" ><b>Item ID:</b></td>
					<td>'.$shop_itemid1.'</td></tr><br>
					<tr><td align="center" ><b>Count Item:</b></td>
					<td>'.$shop_count1.'</td></tr><br>					<tr><td align="center" ><b>Category:</b></td>
					<td>'.$shop_offer_category.'</td></tr><br>';
	...
	if($action == "editoffer") {
		...
		foreach($shopoffers as $shop) {
			...
			if($shop['offer_type'] == 'addon'){
				$main_content .= '<tr><td align="center"><b>Item ID:</b></td>
					<td><input type="text" name="shop_itemid1" maxlenght="7" value="'.$shop['itemid1'].'" style="width: 70px" ></td></tr>
					<tr><td align="center"><b>Item Count:</b></td>
					<td><input type="text" name="shop_count1" maxlenght="7" value="'.$shop['count1'].'" style="width: 70px" ></td></tr>';
			}
			if($shop['offer_type'] == 'mount'){
				$main_content .= '<tr><td align="center"><b>Item ID:</b></td>
					<td><input type="text" name="shop_itemid1" maxlenght="7" value="'.$shop['itemid1'].'" style="width: 70px" ></td></tr>
					<tr><td align="center"><b>Item Count:</b></td>
					<td><input type="text" name="shop_count1" maxlenght="7" value="'.$shop['count1'].'" style="width: 70px" ></td></tr>';
